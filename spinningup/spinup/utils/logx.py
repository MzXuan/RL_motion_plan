...
class Logger:
    ...
    def save_weights(self, saver, session, itr=None):
        if proc_id() == 0:
            checkpoint_file = 'checkpoint.chk' if itr is None else 'checkpoint%d.chk' % itr
            saver.save(session, osp.join(self.output_dir,'chk', checkpoint_file))
    ...
    def setup_tf_saver(self, sess, inputs, outputs):
        ...
        print("saver inputs are and outpus are:", inputs, outputs)
