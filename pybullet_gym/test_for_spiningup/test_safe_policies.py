...
def main(robot_path, human_path, env, itr):
    seed = 50
    np.random.seed(seed)
    ...
    get_human_action = load_normal_policy(sess, human_path, itr)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env", type=str, default="EndEefHandoverEnv-v0")
    args = parser.parse_args()
    main(args.robot_path, args.human_path, args.env, args.itr)
